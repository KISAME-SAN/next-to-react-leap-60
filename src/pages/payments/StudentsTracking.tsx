...
export default function StudentsTracking() {
  ...
  // live update when payments are recorded from other tabs/pages
  useEffect(() => {
    const onStorage = (e: StorageEvent) => {
      if (e.key === "studentPayments") setPayments(getStudentPayments());
    };
  ...
  const rows: Row[] = useMemo(() => {
    ...
    return sorted;
  }, [classeFilter, typePaiement, fraisId, serviceId, mois, classes, eleves, services, fraisAnnexes, feesMap, payments, sortKey, sortDir, statutFilter]);
