-- Créer les tables pour le système de gestion scolaire (sans conflit de trigger)

-- Table des profils utilisateurs (directeurs d'école)
...
-- Modifier la fonction existante pour supporter les profils
